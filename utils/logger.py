...
def get_logger(
    run_name: str, log_dir: str = "logs", memory_only: bool = False
) -> logging.Logger:
    ...
    if not logger.hasHandlers():
        ...
        if memory_only:
            ...
            logger.memory_handler = (
                mem_handler  # salva riferimento per flush successivo
            )
        else:
...
def flush_temp_logger(
    run_name: str, log_level: int, temp_logger: logging.Logger
) -> logging.Logger:
